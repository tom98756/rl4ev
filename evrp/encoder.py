...
from .embedding import EVRInitEmbedding
from .hook import pre_embedding_hook

class Encoder(AutoregressiveEncoder):
    ...
    def __init__(
        ...
        self.init_embedding = EVRInitEmbedding(embed_dim=embed_dim, linear_bias=True)
    ...
    def forward(
        ...
        # pre-encoder process to get edge index and edge attr
        edge_index, edge_attr = pre_embedding_hook(td)

        # Transfer to embedding space
        init_h = self.init_embedding(td, edge_index, edge_attr)
